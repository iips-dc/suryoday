...
<body class="claro">
    ...
    ?>
        ...
        <div dojoType="dijit.layout.BorderContainer" style="width: 100%;height: 100%;"> 
            ...
            <?php
            if(isset($_POST['designation_name'])&&isset($_POST['designation_roles'])){
              echo $designation_name= $_POST['designation_name'];
              echo $designation_roles= $_POST['designation_roles'];
              if(!empty($designation_name) && !empty( $designation_roles)){
                $sql= "INSERT INTO designation(`designation_name`, `roles`) VALUES ('$designation_name','$designation_roles')";
